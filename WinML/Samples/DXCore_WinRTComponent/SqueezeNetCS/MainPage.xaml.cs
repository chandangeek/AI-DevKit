...
namespace SqueezeNetObjectDetection
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async Task LoadModelAsync()
        {
            ...
            // Use the DXCore helper API to create a custom LearningModelDevice.
            ...
            {
                case 0:
                    dev = helper.GetDeviceFromGraphicsAdapter();
                    break; 

                case 1:
                    dev = helper.GetDeviceFromComputeOnlyAdapter();
                    break;
            ...
            if (dev == null)
            {
                throw new Exception("DXCore could not find an adapter meeting the criteria.");
            }
